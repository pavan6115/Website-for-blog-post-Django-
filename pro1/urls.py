...
from django.contrib.auth import views as auth_views  # this is for login and logout 
...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='users/login.html'), name='login'),  #here we used 'as_view' to view the template on the website as we want to and not the default one
